...
with open('docs/rd-saas-complete-guide.v2.md', 'r') as f:
    content = f.read()

# Define all tasks from TASKS_for_v2.md
tasks_data = [
    ("1.1.1", "Initialize Replit Project", "Set up the base React + Node.js project structure", [
    ...
    ("1.1.2", "Configure Development Environment", "Set up all necessary dependencies and build tools", [
    ...
    ("1.1.3", "Database Schema Creation", "Implement PostgreSQL database structure", [
    ...
    ("1.2.1", "Create Landing Page Layout", "Build the main marketing page structure", [
    ...
    ("1.2.2", "Implement Responsive Design", "Ensure mobile-first responsive layout", [
    ...
    ("1.2.3", "Add Marketing Copy & Content", "Populate landing page with conversion-optimized copy", [
    ...
    ("1.3.1", "Build Calculator UI Component", "Create the 4-step calculator interface", [
    ...
    ("1.3.2", "Implement Calculator Logic", "Add calculation engine and real-time updates", [
    ...
    ("1.3.3", "Create Results Display", "Show calculation results and pricing", [
    ...
    ("1.4.1", "Build Lead Capture Modal", "Create email capture overlay", [
    ...
    ("1.4.2", "Implement Lead Storage", "Save leads to database", [
    ...
    ("1.4.3", "Post-Capture Experience", "Show full results after lead capture", [
...
os.makedirs('docs/acceptance', exist_ok=True)

# Generate acceptance files for all tasks
for task_id, title, purpose, requirements in tasks_data:
    filename = f'docs/acceptance/{task_id}.md'
...
print(f"Generated {len(tasks_data)} acceptance files")
